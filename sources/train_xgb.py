# -*- coding: utf-8 -*-
"""
Created on Sun May 31 16:02:12 2020
...
if __name__ == '__main__':
    ...
    all_params = {'max_depth': [3],
                  'learning_rate': [0.1],
                  'min_child_weight': [3],    # 汎化性能
                  'n_estimators': [10000],    # early_stopping_rounds あるので、大きくても勝手に止まる
                  'colsample_bytree': [0.8],    # どのぐらいの割合の特徴を使うか(1だと全部)
                  'colsample_bylevel': [0.8],    # 木の深さによって使う特徴を減らしたりする
                  'reg_alpha': [0.1],    #
